<form id="sejarahForm" method="POST">
    @method('PUT')
    @csrf
    <div class="form-group">
        <label for="sejarah">Sejarah Madrasah</label>
        <textarea name="sejarah" id="sejarah" cols="50" rows="50" class="summernote">{{ $sekolah->sejarah }}</textarea>
        @error('sejarah')
