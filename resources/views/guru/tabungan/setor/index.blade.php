        ...
        <div class="col-lg-12">
            <x-card>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <x-card>
                            <x-slot name="header">Tambah Setor Tunai</x-slot>
                            <form id="formSetor">
                                @csrf
                    ...
                    <div class="col-md-8">
                        <x-card>
                            <x-slot name="header">Rekap Data Setor Tunai</x-slot>
                            <table class="table table-bordered" id="tableSetor">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Tanggal</th>
...
@push('scripts')
    <script>
        ...
        $('#peserta_didik_id').select2({
            ...
            allowClear: true,
            ajax: {
                url: "{{ route('setor.getSiswa') }}", // Ganti dengan route yang sesuai
                dataType: 'json',
                delay: 250,
