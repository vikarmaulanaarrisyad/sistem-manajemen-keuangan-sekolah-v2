...
<body style="background-color:#e9ecef;">
    ...
    <!-- Owl Carousel -->
    <script src="{{ asset('templates') }}/assets/js/plugins/owl-carousel/owl.carousel.min.js"></script>
    <!-- jQuery Circle Progress -->
    <script src="{{ asset('templates') }}/assets/js/plugins/jquery-circle-progress/circle-progress.min.js"></script>
